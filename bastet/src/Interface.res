...
module type MONOID = {
  @ocaml.doc(" A {!MONOID} only needs to be commutative with the {!empty} element. ")
  include SEMIGROUP
  let empty: t
}
...
module type MEDIAL_QUASIGROUP = {
  @ocaml.doc(" Every {!MEDIAL_QUASIGROUP} is isotopic to an {!ABELIAN_GROUP}. ")
...
module type LOOP = {
  @ocaml.doc(" A {!LOOP} only needs to be commutative with the {!empty} element. ")
  include QUASIGROUP
  let empty: t
}

module type LOOP_ANY = {
  @ocaml.doc(" A {!LOOP_ANY} only needs to be commutative with the {!empty} element. ")
  include QUASIGROUP_ANY
  let empty: t<'a>
}

module type GROUP = {
  @ocaml.doc(" Include {i only} either {!LOOP} or {!MONOID}. ")
  include LOOP
...
module type GROUP_ANY = {
  @ocaml.doc(" Include {i only} either {!LOOP_ANY} or {!MONOID_ANY}. ")
  include LOOP_ANY
